...
func (p EnterDisguise4) Enter(l logrus.FieldLogger, c script.Context) bool {
	if script.QuestStarted(l, c)(20301) ||
		...
		if len(_map.CharactersInMap(l)(c.WorldId(), c.ChannelId(), 108010630)) > 0 {
		...
		script.WarpByName(l, c)(108010630, "out00")
		return true
	}

	script.PlayPortalSound(l, c)
	script.WarpByName(l, c)(130010120, "out00")
	return true
}
