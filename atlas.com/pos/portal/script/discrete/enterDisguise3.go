...
func (p EnterDisguise3) Enter(l logrus.FieldLogger, c script.Context) bool {
	if script.QuestStarted(l, c)(20301) ||
		...
		if len(_map.CharactersInMap(l)(c.WorldId(), c.ChannelId(), 108010620)) > 0 {
		...
		script.WarpByName(l, c)(108010620, "out00")
		return true
	}

	script.PlayPortalSound(l, c)
	script.WarpByName(l, c)(130010110, "out00")
	return true
}
