...
func (p EnterTraining) Enter(l logrus.FieldLogger, c script.Context) bool {
	if script.QuestStarted(l, c)(1041) {
		script.PlayPortalSound(l, c)
		script.WarpById(l, c)(1010100, 4)
	} else if script.QuestStarted(l, c)(1042) {
		script.PlayPortalSound(l, c)
		script.WarpById(l, c)(1010200, 4)
	} else if script.QuestStarted(l, c)(1043) {
		script.PlayPortalSound(l, c)
		script.WarpById(l, c)(1010300, 4)
	} else if script.QuestStarted(l, c)(1044) {
		script.PlayPortalSound(l, c)
		script.WarpById(l, c)(1010400, 4)
	} else {
