...
func (p EnterGym) Enter(l logrus.FieldLogger, c script.Context) bool {
	if script.QuestStarted(l, c)(21701) {
		script.PlayPortalSound(l, c)
		script.WarpById(l, c)(914010000, 1)
		return true
	}
	if script.QuestStarted(l, c)(21702) {
		script.PlayPortalSound(l, c)
		script.WarpById(l, c)(914010100, 1)
		return true
	}
	if script.QuestStarted(l, c)(21703) {
		script.PlayPortalSound(l, c)
		script.WarpById(l, c)(914010200, 1)
		return true
	}
