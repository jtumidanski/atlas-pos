...
func initRegistry() *ScriptRegistry {
	...
	s.addPortalScript(discrete.Pianus{})
	s.addPortalScript(discrete.Pinkin{})
	s.addPortalScript(discrete.Populatus00{})
	s.addPortalScript(discrete.PPinkOut{})
	s.addPortalScript(discrete.Q2073{})
	s.addPortalScript(discrete.Q3366In{})
	s.addPortalScript(discrete.Q3366Out{})
	s.addPortalScript(discrete.Q3367In{})
	s.addPortalScript(discrete.Q3367Out{})
	s.addPortalScript(discrete.Q3368In{})
	s.addPortalScript(discrete.Q3368Out{})
	s.addPortalScript(discrete.RaidRest{})
	s.addPortalScript(discrete.RaidStage{})
	s.addPortalScript(discrete.RankRoom{})
	s.addPortalScript(discrete.ReundoDraco{})
	s.addPortalScript(discrete.RienCaveEnter{})
	s.addPortalScript(discrete.RienTutor1{})
	s.addPortalScript(discrete.RienTutor2{})
	s.addPortalScript(discrete.RienTutor3{})
	s.addPortalScript(discrete.RienTutor4{})
	s.addPortalScript(discrete.RienTutor5{})
	s.addPortalScript(discrete.RienTutor6{})
	s.addPortalScript(discrete.RienTutor7{})
	s.addPortalScript(discrete.RienTutor8{})
	s.addPortalScript(discrete.Rnj1Out{})
	s.addPortalScript(discrete.Rnj1Pt00{})
	s.addPortalScript(discrete.Rnj2Out{})
	s.addPortalScript(discrete.Rnj3In0{})
	s.addPortalScript(discrete.Rnj3In1{})
	s.addPortalScript(discrete.Rnj3Out{})
	s.addPortalScript(discrete.Rnj4R1{})
	s.addPortalScript(discrete.Rnj4R2{})
	s.addPortalScript(discrete.Rnj4R3{})
	s.addPortalScript(discrete.Rnj4R4{})
	s.addPortalScript(discrete.Rnj5Rp{})
	s.addPortalScript(discrete.Rnj6Out{})
	s.addPortalScript(discrete.Rnj12In{})
	s.addPortalScript(discrete.Rnj2010{})
	s.addPortalScript(discrete.Rnj202{})
	s.addPortalScript(discrete.RnjExit{})
	s.addPortalScript(discrete.S4Berserk{})
	s.addPortalScript(discrete.S4BerserkMove{})
	s.addPortalScript(discrete.S4Common1Exit{})
	s.addPortalScript(discrete.S4FireHawk{})
	s.addPortalScript(discrete.S4Hitman{})
	s.addPortalScript(discrete.S4IceEagle{})
	s.addPortalScript(discrete.S4MindEnd{})
	s.addPortalScript(discrete.S4Nest{})
	s.addPortalScript(discrete.S4ResurEnter{})
	s.addPortalScript(discrete.S4ResurOut{})
	s.addPortalScript(discrete.S4Resurrection{})
	s.addPortalScript(discrete.S4Rush{})
	s.addPortalScript(discrete.S4ShipOut{})
	s.addPortalScript(discrete.S4SuperOut{})
	s.addPortalScript(discrete.S4TornadoEnter{})
	s.addPortalScript(discrete.SecretDoor{})
	s.addPortalScript(discrete.SecretGate1Open{})
	s.addPortalScript(discrete.SecretGate2Open{})
	s.addPortalScript(discrete.SecretGate3Open{})
	s.addPortalScript(discrete.Skyrom{})
	s.addPortalScript(discrete.SpaceReturn{})
	s.addPortalScript(discrete.SpaceGagaOut0{})
	s.addPortalScript(discrete.SpaceGagaOut1{})
	s.addPortalScript(discrete.SpaceGagaOut2{})
	s.addPortalScript(discrete.SpaceGagaOut3{})
	s.addPortalScript(discrete.SpearGateOpen{})
	s.addPortalScript(discrete.StageBogo{})
	s.addPortalScript(discrete.StatueGateOpen{})
	s.addPortalScript(discrete.StoneGateOpen{})
	s.addPortalScript(discrete.SubwayIn2{})
	s.addPortalScript(discrete.TamePigOut2{})
	s.addPortalScript(discrete.TDBossEnter{})
	s.addPortalScript(discrete.TDChatEnter{})
	s.addPortalScript(discrete.TDMCEGate{})
	s.addPortalScript(discrete.TDMCEnterBoss1{})
	s.addPortalScript(discrete.TDMCEnterBoss2{})
	s.addPortalScript(discrete.TDMCFirst{})
	s.addPortalScript(discrete.TDMCJump{})
	s.addPortalScript(discrete.TDNeoInTree{})
	s.addPortalScript(discrete.TempleEnter{})
	s.addPortalScript(discrete.ThiefIn1{})
	s.addPortalScript(discrete.TimeQuest{})
	s.addPortalScript(discrete.TristanEnter{})
	s.addPortalScript(discrete.TutoChatNPC{})
	s.addPortalScript(discrete.TutorHelper{})
	s.addPortalScript(discrete.TutorialNPC{})
	s.addPortalScript(discrete.TutorMiniMap{})
	s.addPortalScript(discrete.TutorQuest{})
	s.addPortalScript(discrete.Under30Gate{})
	s.addPortalScript(discrete.UndoDraco{})
	s.addPortalScript(discrete.UndoDraco{})
	s.addPortalScript(discrete.WaterGateOpen{})
	s.addPortalScript(discrete.Zakum03{})
	s.addPortalScript(discrete.Zakum05{})
	return s
}
